...
- **Rubric overview**: Win/draw/loss reward, speed bonus, format compliance, invalid move penalty
...
| `speed_reward_func` | 0.1 bonus per free square remaining if X wins |

...
- See the [configs directory](https://github.com/PrimeIntellect-ai/verifiers/tree/main/configs) on GitHub to find training configurations for `prime-rl` and `vf-rl`.